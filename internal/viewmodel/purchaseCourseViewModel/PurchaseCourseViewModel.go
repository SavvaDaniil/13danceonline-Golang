package purchaseCourseViewModel

import (
	"danceonline/internal/viewmodel/courseViewModel"
)

type PurchaseCourseLiteViewModel struct {
	Id                      int                                  `json:"id"`
	Id_of_user              int                                  `json:"id_of_user"`
	Id_of_payment           *int                                 `json:"id_of_payment"`
	CourseMicroViewModel    courseViewModel.CourseMicroViewModel `json:"courseMicroViewModel"`
	Days                    int                                  `json:"days"`
